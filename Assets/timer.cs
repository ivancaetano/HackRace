...
public class timer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!finished)
        {
            ...
            lapscounter.text = "Fase " + currentlap + " / " + laps;
        }
        ...
        if (who.name == "Car")
        {
            ...
            else if (lap < laps + 1)
            {
                ...
                if (lap == laps)
                {
                    ...
                    finallaptext.text = "Última volta";
